    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-4">案例不存在</p>
          <Link to="/cases" className="text-blue-600 hover:underline">返回案例列表</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg">
          ...
          />
          <div className="p-8">
            <span className="inline-block px-3 py-1 text-sm font-medium rounded bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 mb-3">
              {typeLabel}
            </span>
            ...
            {caseItem.techStack?.length > 0 && (
              <div className="mb-6">
                <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-2">技术栈</h3>
        ...
        <div className="mt-8 text-center">
          <Link
            to="/contact"
            className="inline-block px-8 py-3 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-medium rounded-lg transition-colors"
          >
            有类似需求？联系我
          </Link>
        </div>
